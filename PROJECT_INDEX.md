...
- **CRM 产品架构师**（`crm-product-architecture`，v1.0.5）
...
- **客服售前资深经理**（`senior-customer-service-presales-manager`，v1.0.6）
...
- **客服售前资深经理周报**（`senior-customer-service-presales-manager-weekly-report`，v1.0.6）
...
- **跨境客服售前运营专家**（`customer-service-voice-manager`，v2.0.5）
...
- **评价与品牌声誉经理**（`review-reputation-manager`，v1.0.5）
...
- **客户留存与忠诚度经理**（`customer-retention-loyalty-manager`，v1.0.5）
