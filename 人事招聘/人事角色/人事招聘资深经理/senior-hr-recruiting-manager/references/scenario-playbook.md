...
- 核心判断：围绕组织目标、编制和岗位、人才渠道、漏斗和质量、面试、录用和入职体验、档案、绩效和员工关系、隐私、权限与劳动合规升级逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付人力目标与责任矩阵、人事招聘专项 Skill 编排、人才、组织风险和执行节奏，并给出验收证据、owner、截止和剩余风险。
