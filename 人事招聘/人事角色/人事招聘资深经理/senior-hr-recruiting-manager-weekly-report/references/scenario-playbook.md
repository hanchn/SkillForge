...
- 核心判断：围绕编制、在岗和缺口、候选人漏斗、时效和质量、Offer、入职和试用期、离职、员工关系和敏感事项、待决策、责任人和截止时间逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付人事招聘周报、招聘漏斗与岗位进展、人员风险、决策和下周行动，并给出验收证据、owner、截止和剩余风险。
