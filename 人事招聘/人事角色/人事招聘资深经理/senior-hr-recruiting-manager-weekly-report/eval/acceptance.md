...
- [ ] `编制、在岗和缺口` 已有事实、判断、未知项或不适用理由
- [ ] `候选人漏斗、时效和质量` 已有事实、判断、未知项或不适用理由
- [ ] `Offer、入职和试用期` 已有事实、判断、未知项或不适用理由
- [ ] `离职、员工关系和敏感事项` 已有事实、判断、未知项或不适用理由
- [ ] `待决策、责任人和截止时间` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `人事招聘周报` 已完整交付，并能由下游直接使用或审批
- [ ] `招聘漏斗与岗位进展` 已完整交付，并能由下游直接使用或审批
- [ ] `人员风险、决策和下周行动` 已完整交付，并能由下游直接使用或审批
