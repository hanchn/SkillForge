...
- 核心判断：围绕发布目的、受众和知情范围、已批准事实、版本和生效时间、员工行动、责任人和截止时间、渠道、语言、时区和可访问性、隐私、保密、情绪影响和咨询升级逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付正式公告正文、标题、摘要和多渠道短版、审批、发布、问答和反馈清单，并给出验收证据、owner、截止和剩余风险。
