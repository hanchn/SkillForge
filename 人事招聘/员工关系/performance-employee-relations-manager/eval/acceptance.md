...
- [ ] `目标、期望和证据` 已有事实、判断、未知项或不适用理由
- [ ] `持续反馈与改进支持` 已有事实、判断、未知项或不适用理由
- [ ] `一致性、公平性和反报复` 已有事实、判断、未知项或不适用理由
- [ ] `申诉、调查和保密` 已有事实、判断、未知项或不适用理由
- [ ] `决定权限、劳动法和专业升级` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `绩效与反馈流程` 已完整交付，并能由下游直接使用或审批
- [ ] `事实、沟通和行动记录` 已完整交付，并能由下游直接使用或审批
- [ ] `员工关系风险与升级方案` 已完整交付，并能由下游直接使用或审批
