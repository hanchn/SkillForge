...
- 核心判断：围绕岗位、职级、薪酬和预算审批、条件、有效期和候选人沟通、背景核验授权与必要性、合同、账号、设备和培训、试用目标、导师和反馈节点逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付录用审批与 Offer 清单、入职准备责任表、首日、30/60/90 天交接计划，并给出验收证据、owner、截止和剩余风险。
