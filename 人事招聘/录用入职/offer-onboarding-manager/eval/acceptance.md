...
- [ ] `岗位、职级、薪酬和预算审批` 已有事实、判断、未知项或不适用理由
- [ ] `条件、有效期和候选人沟通` 已有事实、判断、未知项或不适用理由
- [ ] `背景核验授权与必要性` 已有事实、判断、未知项或不适用理由
- [ ] `合同、账号、设备和培训` 已有事实、判断、未知项或不适用理由
- [ ] `试用目标、导师和反馈节点` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `录用审批与 Offer 清单` 已完整交付，并能由下游直接使用或审批
- [ ] `入职准备责任表` 已完整交付，并能由下游直接使用或审批
- [ ] `首日、30/60/90 天交接计划` 已完整交付，并能由下游直接使用或审批
