...
- [ ] `商品、集合和内容` 已有事实、判断、未知项或不适用理由
- [ ] `流量、落地页和转化` 已有事实、判断、未知项或不适用理由
- [ ] `促销、结账和支付` 已有事实、判断、未知项或不适用理由
- [ ] `订单、履约和客服` 已有事实、判断、未知项或不适用理由
- [ ] `数据、应用、性能和隐私` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `独立站经营计划` 已完整交付，并能由下游直接使用或审批
- [ ] `上线与健康检查表` 已完整交付，并能由下游直接使用或审批
- [ ] `渠道和站内经营复盘` 已完整交付，并能由下游直接使用或审批
