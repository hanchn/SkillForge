...
- [ ] `店铺和商品健康` 已有事实、判断、未知项或不适用理由
- [ ] `短视频与直播供给` 已有事实、判断、未知项或不适用理由
- [ ] `达人联盟和授权` 已有事实、判断、未知项或不适用理由
- [ ] `广告、活动与转化` 已有事实、判断、未知项或不适用理由
- [ ] `库存、履约、退款和评分` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `TikTok Shop 经营计划` 已完整交付，并能由下游直接使用或审批
- [ ] `内容达人商品协同表` 已完整交付，并能由下游直接使用或审批
- [ ] `店铺健康和复盘` 已完整交付，并能由下游直接使用或审批
