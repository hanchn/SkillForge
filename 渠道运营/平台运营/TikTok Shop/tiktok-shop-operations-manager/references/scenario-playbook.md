...
- 核心判断：围绕店铺和商品健康、短视频与直播供给、达人联盟和授权、广告、活动与转化、库存、履约、退款和评分逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付TikTok Shop 经营计划、内容达人商品协同表、店铺健康和复盘，并给出验收证据、owner、截止和剩余风险。
