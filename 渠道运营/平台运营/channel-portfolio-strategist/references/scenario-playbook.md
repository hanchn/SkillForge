...
## 场景 1：Amazon、Shopify、TikTok 等渠道组合

- 触发信号：什么变化、问题或决策需要启动本 Skill。
- 先决条件：目标、范围、对象、国家/渠道/系统、时间与 owner。
- 最低证据：当前状态、历史基线、约束、事实源、权限和反证。
- 核心判断：围绕客群和购买任务、流量 ownership 与数据可得性、毛利、费用和现金周期、价格、库存和内容冲突、组织能力和试点门槛逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付渠道角色地图、进入与退出评分、资源和治理方案，并给出验收证据、owner、截止和剩余风险。
