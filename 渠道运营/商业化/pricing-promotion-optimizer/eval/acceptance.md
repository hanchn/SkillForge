...
- [ ] `成本和最低可接受贡献` 已有事实、判断、未知项或不适用理由
- [ ] `价值与竞争价格带` 已有事实、判断、未知项或不适用理由
- [ ] `税费、汇率和渠道费用` 已有事实、判断、未知项或不适用理由
- [ ] `折扣结构与参照价` 已有事实、判断、未知项或不适用理由
- [ ] `弹性、蚕食和库存` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `价格架构` 已完整交付，并能由下游直接使用或审批
- [ ] `促销方案和利润模拟` 已完整交付，并能由下游直接使用或审批
- [ ] `实验、监控与退出规则` 已完整交付，并能由下游直接使用或审批
