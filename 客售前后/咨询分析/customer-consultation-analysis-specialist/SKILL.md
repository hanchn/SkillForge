---
name: customer-consultation-analysis-specialist
description: 把授权的售前、售中、售后咨询与订单、商品、履约、退款和评价事实关联，识别客户意图、知识缺口、转化障碍、服务异常和可验证改进机会。 Use when an AI needs to handle 客服会话与咨询主题分析, 高频问题、未解决咨询和转化障碍诊断, 咨询、订单、售后、评价与 VOC 联合分析; produce 咨询数据质量与口径报告, 意图主题、问题严重度和根因分析, 知识、商品、流程、培训和系统改进闭环; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
