...
- [ ] `咨询、售后量、响应和解决质量` 已有事实、判断、未知项或不适用理由
- [ ] `商品事实、推荐适配和转化` 已有事实、判断、未知项或不适用理由
- [ ] `订单、履约、退款退货和投诉升级` 已有事实、判断、未知项或不适用理由
- [ ] `多语言体验、知识库、质检和团队能力` 已有事实、判断、未知项或不适用理由
- [ ] `线索、售后、评价和客户声音闭环` 已有事实、判断、未知项或不适用理由
