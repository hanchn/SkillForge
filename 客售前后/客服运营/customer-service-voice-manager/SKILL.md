...
description: 端到端完成购买前咨询、商品推荐、订单中服务、售后处理、多语言沟通、知识沉淀、质检培训和跨部门交接。 Use when an AI needs to handle 邮件、聊天和平台消息的售前售中售后接待, 商品推荐、订单查询、异议、退款退货与多语言沟通, 客服知识库、投诉升级、线索交接和质量改进; produce 客售前后答复与处理方案, 客服 SOP、FAQ、话术、权限和升级矩阵, 咨询、售后、质检、培训与 VOC 改进报告; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
