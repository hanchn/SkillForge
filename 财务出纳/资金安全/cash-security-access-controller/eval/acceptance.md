...
- [ ] `申请、审批、执行和复核分离` 已有事实、判断、未知项或不适用理由
- [ ] `账户角色、限额与双人复核` 已有事实、判断、未知项或不适用理由
- [ ] `UKey、印鉴和密钥保管` 已有事实、判断、未知项或不适用理由
- [ ] `供应商账户变更验证` 已有事实、判断、未知项或不适用理由
- [ ] `日志、告警、冻结和业务连续性` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `资金权限矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `安全检查与轮换计划` 已完整交付，并能由下游直接使用或审批
- [ ] `异常冻结、取证和恢复预案` 已完整交付，并能由下游直接使用或审批
