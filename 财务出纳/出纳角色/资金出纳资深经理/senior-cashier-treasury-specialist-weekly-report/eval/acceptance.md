...
- [ ] `期初期末余额与可用资金` 已有事实、判断、未知项或不适用理由
- [ ] `收付款笔数、金额与完成状态` 已有事实、判断、未知项或不适用理由
- [ ] `未达账项、退款和在途` 已有事实、判断、未知项或不适用理由
- [ ] `票据、报销和单据完整性` 已有事实、判断、未知项或不适用理由
- [ ] `权限、安全事件与下周大额付款` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `资金出纳资深经理周报` 已完整交付，并能由下游直接使用或审批
- [ ] `资金余额与收付款摘要` 已完整交付，并能由下游直接使用或审批
- [ ] `异常、待复核和下周资金事项` 已完整交付，并能由下游直接使用或审批
