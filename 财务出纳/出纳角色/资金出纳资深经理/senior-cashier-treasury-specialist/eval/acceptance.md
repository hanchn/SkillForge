...
- [ ] `账户、主体与币种` 已有事实、判断、未知项或不适用理由
- [ ] `收款、付款与在途` 已有事实、判断、未知项或不适用理由
- [ ] `票据、单据与审批` 已有事实、判断、未知项或不适用理由
- [ ] `银行日记账和余额核对` 已有事实、判断、未知项或不适用理由
- [ ] `网银权限、印鉴、UKey 与反欺诈` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `出纳责任与权限矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `收付款和日结执行计划` 已完整交付，并能由下游直接使用或审批
- [ ] `资金异常、复核和升级清单` 已完整交付，并能由下游直接使用或审批
