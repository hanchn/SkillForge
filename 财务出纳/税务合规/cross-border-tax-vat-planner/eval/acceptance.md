...
- [ ] `主体、常设机构和交易链` 已有事实、判断、未知项或不适用理由
- [ ] `货物所在地与税收地点` 已有事实、判断、未知项或不适用理由
- [ ] `平台代征与卖家责任` 已有事实、判断、未知项或不适用理由
- [ ] `注册、税率、发票和申报` 已有事实、判断、未知项或不适用理由
- [ ] `关税、转让定价、证据和更新日期` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `交易与税务责任图` 已完整交付，并能由下游直接使用或审批
- [ ] `注册申报和证据日历` 已完整交付，并能由下游直接使用或审批
- [ ] `风险、整改和专业顾问升级清单` 已完整交付，并能由下游直接使用或审批
