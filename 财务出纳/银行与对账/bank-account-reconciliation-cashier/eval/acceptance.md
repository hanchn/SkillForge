...
- [ ] `账户状态、用途和授权人` 已有事实、判断、未知项或不适用理由
- [ ] `账面、银行与可用余额` 已有事实、判断、未知项或不适用理由
- [ ] `流水唯一标识和交易对手` 已有事实、判断、未知项或不适用理由
- [ ] `未达账原因与账龄` 已有事实、判断、未知项或不适用理由
- [ ] `调节项证据、复核和关闭` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `账户与余额台账` 已完整交付，并能由下游直接使用或审批
- [ ] `银行日记账核对表` 已完整交付，并能由下游直接使用或审批
- [ ] `未达账、差异和跟进清单` 已完整交付，并能由下游直接使用或审批
