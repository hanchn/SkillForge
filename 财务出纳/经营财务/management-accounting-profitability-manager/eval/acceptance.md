...
- [ ] `法定与管理口径桥` 已有事实、判断、未知项或不适用理由
- [ ] `收入、退款和折扣` 已有事实、判断、未知项或不适用理由
- [ ] `采购、履约、平台和广告成本` 已有事实、判断、未知项或不适用理由
- [ ] `共同成本和分摊原则` 已有事实、判断、未知项或不适用理由
- [ ] `贡献利润、现金和决策敏感性` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `管理利润口径` 已完整交付，并能由下游直接使用或审批
- [ ] `商品渠道盈利矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `差异、情景和经营建议` 已完整交付，并能由下游直接使用或审批
