...
- [ ] `会计主体与账套` 已有事实、判断、未知项或不适用理由
- [ ] `收入、成本和利润口径` 已有事实、判断、未知项或不适用理由
- [ ] `现金、结算和营运资金` 已有事实、判断、未知项或不适用理由
- [ ] `预算、预测和差异` 已有事实、判断、未知项或不适用理由
- [ ] `税务、外汇、控制和审计证据` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `财务目标与责任矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `专项财务 Skill 编排` 已完整交付，并能由下游直接使用或审批
- [ ] `关账、现金、预算和风险计划` 已完整交付，并能由下游直接使用或审批
