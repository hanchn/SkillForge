...
- [ ] `数据截止和关账状态` 已有事实、判断、未知项或不适用理由
- [ ] `收入、利润和预算差异` 已有事实、判断、未知项或不适用理由
- [ ] `现金、应收应付和库存` 已有事实、判断、未知项或不适用理由
- [ ] `税务、汇率和申报期限` 已有事实、判断、未知项或不适用理由
- [ ] `控制缺口与待决策事项` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `财务周报` 已完整交付，并能由下游直接使用或审批
- [ ] `现金、利润和风险摘要` 已完整交付，并能由下游直接使用或审批
- [ ] `决策、责任人与下周行动` 已完整交付，并能由下游直接使用或审批
