...
- [ ] `申请人、成本中心和用途` 已有事实、判断、未知项或不适用理由
- [ ] `预算与审批链` 已有事实、判断、未知项或不适用理由
- [ ] `发票、收据和重复报销` 已有事实、判断、未知项或不适用理由
- [ ] `借支、核销和逾期` 已有事实、判断、未知项或不适用理由
- [ ] `付款回单、档案和隐私` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `报销校验清单` 已完整交付，并能由下游直接使用或审批
- [ ] `付款与退回台账` 已完整交付，并能由下游直接使用或审批
- [ ] `备用金、票据和异常跟踪表` 已完整交付，并能由下游直接使用或审批
