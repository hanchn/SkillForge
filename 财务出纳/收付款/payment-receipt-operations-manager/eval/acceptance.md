...
- [ ] `付款主体、账户和币种` 已有事实、判断、未知项或不适用理由
- [ ] `申请、合同、发票与审批` 已有事实、判断、未知项或不适用理由
- [ ] `收款识别和核销线索` 已有事实、判断、未知项或不适用理由
- [ ] `支付状态、回单和在途` 已有事实、判断、未知项或不适用理由
- [ ] `重复支付、篡改和欺诈拦截` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `收付款 SOP 与权限矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `支付批次和状态台账` 已完整交付，并能由下游直接使用或审批
- [ ] `回单、异常和升级记录` 已完整交付，并能由下游直接使用或审批
