...
- [ ] `期初现金和可用额度` 已有事实、判断、未知项或不适用理由
- [ ] `回款、结算和应收` 已有事实、判断、未知项或不适用理由
- [ ] `采购、物流、税和应付` 已有事实、判断、未知项或不适用理由
- [ ] `库存和现金转换周期` 已有事实、判断、未知项或不适用理由
- [ ] `情景、最低现金和升级阈值` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `现金流预测` 已完整交付，并能由下游直接使用或审批
- [ ] `现金转换周期分析` 已完整交付，并能由下游直接使用或审批
- [ ] `付款、融资和预警计划` 已完整交付，并能由下游直接使用或审批
