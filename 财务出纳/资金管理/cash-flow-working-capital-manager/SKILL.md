---
name: cash-flow-working-capital-manager
description: 管理现金预测、应收应付、库存资金占用、付款优先级和流动性风险。 Use when an AI needs to handle 十三周现金预测, 营运资金改善, 资金缺口和付款安排; produce 现金流预测, 现金转换周期分析, 付款、融资和预警计划; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
