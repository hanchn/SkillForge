...
- [ ] `账户、主体和币种` 已有事实、判断、未知项或不适用理由
- [ ] `应收应付自然对冲` 已有事实、判断、未知项或不适用理由
- [ ] `结算周期和费用` 已有事实、判断、未知项或不适用理由
- [ ] `汇率情景与风险限额` 已有事实、判断、未知项或不适用理由
- [ ] `付款权限、欺诈和银行连续性` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `币种资金头寸` 已完整交付，并能由下游直接使用或审批
- [ ] `汇率暴露与情景` 已完整交付，并能由下游直接使用或审批
- [ ] `换汇、归集、权限和预警方案` 已完整交付，并能由下游直接使用或审批
