...
## 场景 1：诊断指标上涨、下跌、异常或预测未达

- 业务理解：解释本场景的对象、术语、启动原因、结果使用者和错误后果。
- 输入与补证：必需 metric_and_comparison；建议补充 queries_or_files、dashboard、change_log、segments；来源、日期、版本和可信度必须记录。
...
- 完成：交付 metric_diagnostic.md、contribution_table、hypothesis_scorecard，并附验收证据、责任人、截止、停止条件和复盘时间。

## 场景 2：解释漏斗、收入、活跃和留存变化
...
不把相关性写成因果；不比较不完整与完整周期而不说明；不以小样本百分比变化代替贡献度
