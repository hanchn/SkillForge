...
- [ ] `spend、delivery 和归因窗口` 已有事实、判断、未知项或不适用理由
- [ ] `CTR、CVR、CPA、ROAS 与 TACOS` 已有事实、判断、未知项或不适用理由
- [ ] `新客、毛利和回收期` 已有事实、判断、未知项或不适用理由
- [ ] `campaign、audience 和 creative` 已有事实、判断、未知项或不适用理由
- [ ] `平台偏差、饱和和增量` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `广告表现报告` 已完整交付，并能由下游直接使用或审批
- [ ] `驱动拆解与预算建议` 已完整交付，并能由下游直接使用或审批
- [ ] `增量验证和测试计划` 已完整交付，并能由下游直接使用或审批
