...
- 核心判断：围绕spend、delivery 和归因窗口、CTR、CVR、CPA、ROAS 与 TACOS、新客、毛利和回收期、campaign、audience 和 creative、平台偏差、饱和和增量逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付广告表现报告、驱动拆解与预算建议、增量验证和测试计划，并给出验收证据、owner、截止和剩余风险。
