...
- [ ] `漏斗定义和可比 cohort` 已有事实、判断、未知项或不适用理由
- [ ] `曝光、查看、加购、结账和购买` 已有事实、判断、未知项或不适用理由
- [ ] `设备、页面、国家和渠道` 已有事实、判断、未知项或不适用理由
- [ ] `性能、错误、支付和库存` 已有事实、判断、未知项或不适用理由
- [ ] `统计不确定性和实验` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `漏斗诊断` 已完整交付，并能由下游直接使用或审批
- [ ] `流失分层和证据` 已完整交付，并能由下游直接使用或审批
- [ ] `实验与修复优先级` 已完整交付，并能由下游直接使用或审批
