...
- [ ] `订单状态与收入确认` 已有事实、判断、未知项或不适用理由
- [ ] `平台费、履约、广告和退款` 已有事实、判断、未知项或不适用理由
- [ ] `新客、复购和数据 ownership` 已有事实、判断、未知项或不适用理由
- [ ] `库存和现金周期` 已有事实、判断、未知项或不适用理由
- [ ] `渠道特有价值与不可比项` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `渠道可比口径` 已完整交付，并能由下游直接使用或审批
- [ ] `规模效率利润矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `渠道角色和资源建议` 已完整交付，并能由下游直接使用或审批
