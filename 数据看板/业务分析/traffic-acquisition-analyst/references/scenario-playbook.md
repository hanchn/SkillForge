...
- 核心判断：围绕user/session scope、source、medium、campaign 规范、新客、参与和落地页、转化、收入和 LTV、bot、direct 和跨域污染逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付流量来源分析、质量与成本矩阵、归因限制和优化建议，并给出验收证据、owner、截止和剩余风险。
