...
- [ ] `user/session scope` 已有事实、判断、未知项或不适用理由
- [ ] `source、medium、campaign 规范` 已有事实、判断、未知项或不适用理由
- [ ] `新客、参与和落地页` 已有事实、判断、未知项或不适用理由
- [ ] `转化、收入和 LTV` 已有事实、判断、未知项或不适用理由
- [ ] `bot、direct 和跨域污染` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `流量来源分析` 已完整交付，并能由下游直接使用或审批
- [ ] `质量与成本矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `归因限制和优化建议` 已完整交付，并能由下游直接使用或审批
