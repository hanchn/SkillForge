...
- [ ] `基线和对照` 已有事实、判断、未知项或不适用理由
- [ ] `价格、折扣和实际成交价` 已有事实、判断、未知项或不适用理由
- [ ] `销量、转化和弹性` 已有事实、判断、未知项或不适用理由
- [ ] `毛利、补贴和贡献` 已有事实、判断、未知项或不适用理由
- [ ] `提前购买、蚕食和新客质量` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `价格促销效果报告` 已完整交付，并能由下游直接使用或审批
- [ ] `增量和蚕食测算` 已完整交付，并能由下游直接使用或审批
- [ ] `机制优化建议` 已完整交付，并能由下游直接使用或审批
