...
- [ ] `客户身份与 cohort 定义` 已有事实、判断、未知项或不适用理由
- [ ] `复购、留存和间隔` 已有事实、判断、未知项或不适用理由
- [ ] `收入、毛利和贡献 LTV` 已有事实、判断、未知项或不适用理由
- [ ] `渠道、国家和首购商品` 已有事实、判断、未知项或不适用理由
- [ ] `截尾、退款和预测偏差` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `cohort 留存表` 已完整交付，并能由下游直接使用或审批
- [ ] `LTV/CAC 和回收期` 已完整交付，并能由下游直接使用或审批
- [ ] `分层策略与不确定性` 已完整交付，并能由下游直接使用或审批
