...
- 核心判断：围绕客户身份与 cohort 定义、复购、留存和间隔、收入、毛利和贡献 LTV、渠道、国家和首购商品、截尾、退款和预测偏差逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付cohort 留存表、LTV/CAC 和回收期、分层策略与不确定性，并给出验收证据、owner、截止和剩余风险。
