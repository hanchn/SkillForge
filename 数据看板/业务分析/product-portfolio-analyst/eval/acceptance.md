...
- [ ] `流量、转化和销量` 已有事实、判断、未知项或不适用理由
- [ ] `毛利和贡献` 已有事实、判断、未知项或不适用理由
- [ ] `库存周转和缺货` 已有事实、判断、未知项或不适用理由
- [ ] `评价退货和生命周期` 已有事实、判断、未知项或不适用理由
- [ ] `替代、互补和蚕食` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `商品组合矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `SKU 诊断与动作` 已完整交付，并能由下游直接使用或审批
- [ ] `新品、保留和退出规则` 已完整交付，并能由下游直接使用或审批
