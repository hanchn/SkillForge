...
- [ ] `业务定义与公式` 已有事实、判断、未知项或不适用理由
- [ ] `粒度、去重和状态` 已有事实、判断、未知项或不适用理由
- [ ] `时区、币种和税口径` 已有事实、判断、未知项或不适用理由
- [ ] `来源、owner 和刷新` 已有事实、判断、未知项或不适用理由
- [ ] `版本、测试和认证` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `指标字典` 已完整交付，并能由下游直接使用或审批
- [ ] `维度与数据血缘` 已完整交付，并能由下游直接使用或审批
- [ ] `变更、认证和争议处理机制` 已完整交付，并能由下游直接使用或审批
