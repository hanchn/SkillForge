...
- [ ] `销量、价格和组合` 已有事实、判断、未知项或不适用理由
- [ ] `退款、折扣和税费` 已有事实、判断、未知项或不适用理由
- [ ] `平台、支付、物流和广告成本` 已有事实、判断、未知项或不适用理由
- [ ] `固定与变动成本` 已有事实、判断、未知项或不适用理由
- [ ] `币种、时点和贡献层级` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `收入利润桥` 已完整交付，并能由下游直接使用或审批
- [ ] `分层盈利矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `驱动、风险和改善测算` 已完整交付，并能由下游直接使用或审批
