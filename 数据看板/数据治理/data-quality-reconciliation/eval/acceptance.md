...
- [ ] `来源、抽取时间和范围` 已有事实、判断、未知项或不适用理由
- [ ] `主键、重复和缺失` 已有事实、判断、未知项或不适用理由
- [ ] `状态、时区、币种和税` 已有事实、判断、未知项或不适用理由
- [ ] `迟到、回补和快照` 已有事实、判断、未知项或不适用理由
- [ ] `容差、证据和 owner` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `数据质量报告` 已完整交付，并能由下游直接使用或审批
- [ ] `差异桥和根因` 已完整交付，并能由下游直接使用或审批
- [ ] `修复、监控和责任清单` 已完整交付，并能由下游直接使用或审批
