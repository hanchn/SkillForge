...
- 184 个正式 Skill 包，其中 183 个在可视化管理页展示。
...
- [创意拍摄 Skill 地图](创意拍摄/CREATIVE_PRODUCTION_SKILLS_MAP.md)
...
- 业务目录：如 `渠道运营/`、`客服售前/`、`精准营销/`、`创意拍摄/`、`市场采购/`、`仓储库存/`、`互联网研发/`、`数据看板/`、`法律政务/`、`财务出纳/`、`人事招聘/`、`项目管理/`
...
| 5.8.0 | 2026-07-15 | 创意拍摄新增智能打标 Skill，并将 AI 图片视频成片升级为完整 AIGC 创意制作能力。 |
...
| 5.2.0 | 2026-07-15 | 将创意拍摄升级为一级分类，新增主角色、传统制作、虚拟模特、AI 成片、智能剪辑和真实性合规 Skill；新增 UI 交互能力和全局类型标签。 |
