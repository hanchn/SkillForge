...
- 核心判断：围绕规格、BOM、外观和使用场景、供应商、版本、日期和样品身份、功能、耐久、安全和包装测试、目标成本、可制造性和公差、问题关闭、黄金样、签核和变更控制逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付样品需求与版本台账、比样、测试和问题矩阵、修改、封样、量产和否决决定，并给出验收证据、owner、截止和剩余风险。
