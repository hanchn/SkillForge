...
- 核心判断：围绕规格、数量和报价可比性、材料、人工、制造、包装和物流、MOQ、阶梯价、模具和开发费、付款、汇率、交期、赔付和质保、替代供应、总拥有成本和关系风险逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付报价可比表与成本模型、谈判目标、底线和换项方案、商务条款、决策和复盘记录，并给出验收证据、owner、截止和剩余风险。
