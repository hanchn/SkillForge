...
- [ ] `申请、预算、合同和审批` 已有事实、判断、未知项或不适用理由
- [ ] `SKU、规格、数量、价格和币种` 已有事实、判断、未知项或不适用理由
- [ ] `生产、质检、装运和到仓节点` 已有事实、判断、未知项或不适用理由
- [ ] `付款条件、单据和三方匹配` 已有事实、判断、未知项或不适用理由
- [ ] `变更、短交、延期、索赔和关闭` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `采购订单与里程碑台账` 已完整交付，并能由下游直接使用或审批
- [ ] `交期、质量和付款跟踪` 已完整交付，并能由下游直接使用或审批
- [ ] `变更、索赔、关闭和供应商绩效记录` 已完整交付，并能由下游直接使用或审批
