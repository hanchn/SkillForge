...
- 核心判断：围绕申请、预算、合同和审批、SKU、规格、数量、价格和币种、生产、质检、装运和到仓节点、付款条件、单据和三方匹配、变更、短交、延期、索赔和关闭逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付采购订单与里程碑台账、交期、质量和付款跟踪、变更、索赔、关闭和供应商绩效记录，并给出验收证据、owner、截止和剩余风险。
