---
name: procurement-risk-compliance-manager
description: 识别供应商、产地、材料、质量、合规、制裁、集中度、产能、灾害和商业连续性风险。 Use when an AI needs to handle 新供应商准入, 单一来源和供应中断治理, 采购合规与供应链尽调; produce 采购风险与责任矩阵, 供应商尽调和证据缺口, 替代来源、缓解、监控和升级计划; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---

# 采购风险与供应韧性经理

识别供应商、产地、材料、质量、合规、制裁、集中度、产能、灾害和商业连续性风险。
...
- 不得把供应商自我声明当作充分证据；制裁、强迫劳动、重大质量或产品安全红旗必须暂停并升级法务与合规人员。
