...
- 核心判断：围绕主体、所有权和经营资质、产地、材料、劳工和环境证据、制裁、出口管制和产品合规、产能、质量、财务和集中度、备选供应、模具数据权利和退出连续性逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付采购风险与责任矩阵、供应商尽调和证据缺口、替代来源、缓解、监控和升级计划，并给出验收证据、owner、截止和剩余风险。
