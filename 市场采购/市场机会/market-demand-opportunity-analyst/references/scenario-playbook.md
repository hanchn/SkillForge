...
- 核心判断：围绕目标人群、场景和未满足需求、搜索、销量、评价和季节证据、竞争、价格带和差异空间、目标成本、毛利和现金周期、合规、供应可行性、反证和试点门槛逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付市场机会与证据表、需求、竞争和利润评分、样品验证、否决条件和决策计划，并给出验收证据、owner、截止和剩余风险。
