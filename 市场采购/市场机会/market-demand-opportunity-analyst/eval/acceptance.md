...
- [ ] `目标人群、场景和未满足需求` 已有事实、判断、未知项或不适用理由
- [ ] `搜索、销量、评价和季节证据` 已有事实、判断、未知项或不适用理由
- [ ] `竞争、价格带和差异空间` 已有事实、判断、未知项或不适用理由
- [ ] `目标成本、毛利和现金周期` 已有事实、判断、未知项或不适用理由
- [ ] `合规、供应可行性、反证和试点门槛` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `市场机会与证据表` 已完整交付，并能由下游直接使用或审批
- [ ] `需求、竞争和利润评分` 已完整交付，并能由下游直接使用或审批
- [ ] `样品验证、否决条件和决策计划` 已完整交付，并能由下游直接使用或审批
