...
- [ ] route、layout 与项目结构 已定义、验证或标记为未知
- [ ] load、form actions 和 remote functions 已定义、验证或标记为未知
- [ ] server-only 模块与 secrets 已定义、验证或标记为未知
- [ ] SSR、prerender 和客户端状态 已定义、验证或标记为未知
- [ ] hooks、errors、adapter 和 observability 已定义、验证或标记为未知
