...
- 核心判断：围绕先确认 CMS 缩写和业务边界、内容类型、字段和资产关系、版本、草稿、审批和审计、语言、市场和渠道覆盖、CMS 与 PLM/PIM/渠道前台边界逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付CMS 能力地图、内容模型与版本机制、审批、本地化和分发契约，并给出验收证据、owner、截止和剩余风险。
