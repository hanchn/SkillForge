...
- [ ] `产品概念、款式和规格` 已有事实、判断、未知项或不适用理由
- [ ] `BOM、材料和供应商` 已有事实、判断、未知项或不适用理由
- [ ] `样品、测试和变更` 已有事实、判断、未知项或不适用理由
- [ ] `成本、合规和上市门禁` 已有事实、判断、未知项或不适用理由
- [ ] `PLM 与 CMS/PIM/ERP/供应链边界` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `PLM 能力地图` 已完整交付，并能由下游直接使用或审批
- [ ] `产品版本和阶段门模型` 已完整交付，并能由下游直接使用或审批
- [ ] `BOM、样品、成本、合规与集成方案` 已完整交付，并能由下游直接使用或审批
