...
- 核心判断：围绕产品概念、款式和规格、BOM、材料和供应商、样品、测试和变更、成本、合规和上市门禁、PLM 与 CMS/PIM/ERP/供应链边界逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付PLM 能力地图、产品版本和阶段门模型、BOM、样品、成本、合规与集成方案，并给出验收证据、owner、截止和剩余风险。
