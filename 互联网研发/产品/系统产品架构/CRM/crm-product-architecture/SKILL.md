...
description: 围绕统一客户、身份解析、同意偏好、线索商机、互动服务、分群旅程和生命周期运营设计可审计的 CRM 产品架构。 Use when an AI needs to handle 跨渠道客户中心与客户 360, 营销、销售与客售前后 CRM, 线索、商机、服务工单和生命周期运营, CRM 重构、迁移、主数据与权限治理; produce CRM 业务能力与角色权限地图, 客户身份、账户、联系人、同意和主数据模型, 线索、商机、互动、工单、分群和旅程状态机, CRM 与 CDP/OMS/CMS/客服/营销/数据平台集成及迁移方案; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
