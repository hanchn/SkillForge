...
- [CRM 产品架构师](CRM/crm-product-architecture/README.md)：围绕统一客户、同意偏好、互动、服务、分群和生命周期运营设计 CRM 产品架构。适用于跨渠道客户中心、营销与客服 CRM、客户 360 和生命周期运营，交付CRM 能力地图、客户身份与同意模型、互动、分群、任务和集成方案。
