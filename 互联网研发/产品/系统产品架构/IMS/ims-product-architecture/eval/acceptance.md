...
- [ ] `SKU、库存位置和批次` 已有事实、判断、未知项或不适用理由
- [ ] `现货、在途、锁定和不可售` 已有事实、判断、未知项或不适用理由
- [ ] `预占、扣减、释放和补偿` 已有事实、判断、未知项或不适用理由
- [ ] `ATP/ATS 与渠道同步` 已有事实、判断、未知项或不适用理由
- [ ] `IMS 与 OMS/OFS/WMS 边界` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `IMS 能力地图` 已完整交付，并能由下游直接使用或审批
- [ ] `库存账本和状态模型` 已完整交付，并能由下游直接使用或审批
- [ ] `预占、同步、对账和异常方案` 已完整交付，并能由下游直接使用或审批
