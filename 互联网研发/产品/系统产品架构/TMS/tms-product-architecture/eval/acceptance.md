...
- [ ] `运输需求和运输订单` 已有事实、判断、未知项或不适用理由
- [ ] `承运商、服务和线路` 已有事实、判断、未知项或不适用理由
- [ ] `询价、比价、面单和交接` 已有事实、判断、未知项或不适用理由
- [ ] `轨迹、时效和异常` 已有事实、判断、未知项或不适用理由
- [ ] `计费、对账与 OMS/OFS/WMS 边界` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `TMS 能力地图` 已完整交付，并能由下游直接使用或审批
- [ ] `运输订单与状态机` 已完整交付，并能由下游直接使用或审批
- [ ] `承运商、轨迹、费用和异常方案` 已完整交付，并能由下游直接使用或审批
