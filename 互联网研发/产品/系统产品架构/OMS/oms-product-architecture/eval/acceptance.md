...
- [ ] `订单来源和统一模型` 已有事实、判断、未知项或不适用理由
- [ ] `价格、支付、风控和校验` 已有事实、判断、未知项或不适用理由
- [ ] `拆单、合单和路由` 已有事实、判断、未知项或不适用理由
- [ ] `取消、退款、退换和逆向` 已有事实、判断、未知项或不适用理由
- [ ] `OMS 与 IMS/OFS/CRM/财务边界` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `OMS 能力地图` 已完整交付，并能由下游直接使用或审批
- [ ] `订单域模型与状态机` 已完整交付，并能由下游直接使用或审批
- [ ] `路由、异常和集成契约` 已完整交付，并能由下游直接使用或审批
