...
- 核心判断：围绕标签对象、taxonomy 和 owner、草稿、审核、发布和废弃状态、修改原因、diff 和影响范围、权限、双人复核和批量操作、版本、血缘、回滚和质量指标逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付标签生命周期和状态机、角色权限、审核与发布流程、版本、审计、回滚和质量方案，并给出验收证据、owner、截止和剩余风险。
