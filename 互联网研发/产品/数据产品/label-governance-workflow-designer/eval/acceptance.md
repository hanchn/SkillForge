...
- [ ] `标签对象、taxonomy 和 owner` 已有事实、判断、未知项或不适用理由
- [ ] `草稿、审核、发布和废弃状态` 已有事实、判断、未知项或不适用理由
- [ ] `修改原因、diff 和影响范围` 已有事实、判断、未知项或不适用理由
- [ ] `权限、双人复核和批量操作` 已有事实、判断、未知项或不适用理由
- [ ] `版本、血缘、回滚和质量指标` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `标签生命周期和状态机` 已完整交付，并能由下游直接使用或审批
- [ ] `角色权限、审核与发布流程` 已完整交付，并能由下游直接使用或审批
- [ ] `版本、审计、回滚和质量方案` 已完整交付，并能由下游直接使用或审批
