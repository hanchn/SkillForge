...
## 场景 1：把口头需求或工单整理为完整 PRD

- 业务理解：解释本场景的对象、术语、启动原因、结果使用者和错误后果。
- 输入与补证：必需 product_brief_or_existing_prd；建议补充 source_evidence、technical_constraints、stakeholders、target_metrics；来源、日期、版本和可信度必须记录。
...
- 完成：交付 requirements_package.md、traceability_matrix.md、open_decisions.md，并附验收证据、责任人、截止、停止条件和复盘时间。

## 场景 2：审查现有需求文档是否具备开发与测试条件
...
不代替产品负责人做未授权的商业决策；不把假设包装成已确认事实；不把技术方案细节混成产品需求
