...
- [ ] `市场节点和提前期` 已有事实、判断、未知项或不适用理由
- [ ] `活动目标与目标人群` 已有事实、判断、未知项或不适用理由
- [ ] `折扣、毛利和库存` 已有事实、判断、未知项或不适用理由
- [ ] `渠道规则与价格一致性` 已有事实、判断、未知项或不适用理由
- [ ] `素材、技术、客服和复盘` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `年度/季度活动日历` 已完整交付，并能由下游直接使用或审批
- [ ] `活动机制和资源表` 已完整交付，并能由下游直接使用或审批
- [ ] `上线检查与复盘模板` 已完整交付，并能由下游直接使用或审批
