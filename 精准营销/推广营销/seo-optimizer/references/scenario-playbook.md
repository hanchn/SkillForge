...
## 场景 1：新建商品页、集合页、落地页或文章的 SEO brief

- 业务理解：解释本场景的对象、术语、启动原因、结果使用者和错误后果。
- 输入与补证：必需 page_or_content_goal；建议补充 target_market、business_facts、url、keyword_or_serp_data、performance_data；来源、日期、版本和可信度必须记录。
...
- 完成：交付 seo_audit_or_content.md、keyword_intent_map.md、measurement_plan.md，并附验收证据、责任人、截止、停止条件和复盘时间。

## 场景 2：优化标题、H1、meta、正文结构和内链
...
不得虚构关键词数据、排名、商品事实或权威背书；不得保证排名；不得使用关键词堆砌、门页或无关结构化数据
