...
- [ ] `人群与内容匹配` 已有事实、判断、未知项或不适用理由
- [ ] `真实性和历史表现` 已有事实、判断、未知项或不适用理由
- [ ] `合作模式与单位经济` 已有事实、判断、未知项或不适用理由
- [ ] `寄样、交付和授权` 已有事实、判断、未知项或不适用理由
- [ ] `归因、增量和合规披露` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `达人分层池` 已完整交付，并能由下游直接使用或审批
- [ ] `合作 brief 与跟进管道` 已完整交付，并能由下游直接使用或审批
- [ ] `佣金、授权和效果复盘` 已完整交付，并能由下游直接使用或审批
