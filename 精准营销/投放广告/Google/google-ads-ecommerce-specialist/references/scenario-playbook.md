...
- 核心判断：围绕转化目标、价值、增强型转化和同意、Search 关键词、搜索词和否定词、Merchant Center Feed 与商品诊断、Performance Max 资产组、URL 扩展和品牌控制、落地页质量、利润、增量和止损逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付Google Ads 投放与测量方案、关键词、搜索词、Feed、资产组和预算矩阵、诊断、实验、自检和复盘记录，并给出验收证据、owner、截止和剩余风险。
