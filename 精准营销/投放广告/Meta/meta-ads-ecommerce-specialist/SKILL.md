---
name: meta-ads-ecommerce-specialist
description: 以独立站真实利润、新客质量和可验证增量为目标，端到端规划、搭建、诊断和扩量 Meta 广告。 Use when an AI needs to handle Meta 独立站冷启动和新品投放, Pixel 与 Conversions API 测量治理, 账户诊断、素材测试、扩量和止损; produce Meta 投放与测量方案, Campaign、广告组、素材和预算矩阵, 诊断、实验、自检和复盘记录; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
