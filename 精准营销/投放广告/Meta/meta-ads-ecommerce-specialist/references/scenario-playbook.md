...
- 核心判断：围绕业务目标、贡献利润和回收期、Pixel、CAPI、事件去重和数据质量、账户、campaign、ad set 和 ad 结构、人群、版位、素材角度和疲劳、归因偏差、增量、扩量与止损逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付Meta 投放与测量方案、Campaign、广告组、素材和预算矩阵、诊断、实验、自检和复盘记录，并给出验收证据、owner、截止和剩余风险。
