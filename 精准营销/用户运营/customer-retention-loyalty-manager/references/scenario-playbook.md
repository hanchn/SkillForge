...
- 核心判断：围绕客户身份、同意、新老客和会员口径、cohort、RFM、LTV、复购周期和成熟度、激活、首购、二购、活跃、沉默、流失和召回状态、积分、等级、权益、推荐、成本和负债、触达频控、优惠依赖、对照实验、增量留存和贡献利润逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付新客、老客、会员和流失定义及数据质量报告、生命周期分层、状态机、触发、频控和跨渠道旅程、会员权益、积分负债、成本、毛利和体验模型、召回挽留实验、增量评估、止损与复盘，并给出验收证据、owner、截止和剩余风险。
