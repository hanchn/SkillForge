...
- [ ] `同意、偏好和退订` 已有事实、判断、未知项或不适用理由
- [ ] `触发、频控和冲突` 已有事实、判断、未知项或不适用理由
- [ ] `分群与个性化` 已有事实、判断、未知项或不适用理由
- [ ] `内容、优惠和落地页` 已有事实、判断、未知项或不适用理由
- [ ] `送达、增量收入和实验` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `生命周期流程图` 已完整交付，并能由下游直接使用或审批
- [ ] `分群、触发与内容方案` 已完整交付，并能由下游直接使用或审批
- [ ] `实验和送达健康看板` 已完整交付，并能由下游直接使用或审批
