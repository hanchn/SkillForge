...
- [ ] `业务问题和转化窗口` 已有事实、判断、未知项或不适用理由
- [ ] `用户、会话和平台口径` 已有事实、判断、未知项或不适用理由
- [ ] `身份、UTM 和事件质量` 已有事实、判断、未知项或不适用理由
- [ ] `模型偏差和不可观测触点` 已有事实、判断、未知项或不适用理由
- [ ] `增量实验与预算决策` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `归因测量方案` 已完整交付，并能由下游直接使用或审批
- [ ] `渠道数据和 UTM 规范` 已完整交付，并能由下游直接使用或审批
- [ ] `模型差异、实验与决策规则` 已完整交付，并能由下游直接使用或审批
