...
- 核心判断：围绕新客定义、排除和去重、人群、需求和渠道任务、创意、落地页和首购转化、CAC、首单贡献和回收期、归因、增量、欺诈和留存质量逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付新客增长模型与渠道组合、首触达到首购漏斗方案、预算、实验、回收期和止损计划，并给出验收证据、owner、截止和剩余风险。

## 场景 2：付费、自然、达人和推荐获客组合
