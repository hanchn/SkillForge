...
- [ ] `新客定义、排除和去重` 已有事实、判断、未知项或不适用理由
- [ ] `人群、需求和渠道任务` 已有事实、判断、未知项或不适用理由
- [ ] `创意、落地页和首购转化` 已有事实、判断、未知项或不适用理由
- [ ] `CAC、首单贡献和回收期` 已有事实、判断、未知项或不适用理由
- [ ] `归因、增量、欺诈和留存质量` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `新客增长模型与渠道组合` 已完整交付，并能由下游直接使用或审批
- [ ] `首触达到首购漏斗方案` 已完整交付，并能由下游直接使用或审批
- [ ] `预算、实验、回收期和止损计划` 已完整交付，并能由下游直接使用或审批
