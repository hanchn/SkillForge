...
- [ ] `增长方程和北极星指标` 已有事实、判断、未知项或不适用理由
- [ ] `获客质量与转化` 已有事实、判断、未知项或不适用理由
- [ ] `客单、复购和毛利` 已有事实、判断、未知项或不适用理由
- [ ] `库存、履约和体验约束` 已有事实、判断、未知项或不适用理由
- [ ] `实验优先级和组织 cadence` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `增长模型和机会树` 已完整交付，并能由下游直接使用或审批
- [ ] `实验组合与责任矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `周度经营节奏和复盘` 已完整交付，并能由下游直接使用或审批
