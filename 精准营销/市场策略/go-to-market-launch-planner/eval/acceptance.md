...
- [ ] `市场与产品准备度` 已有事实、判断、未知项或不适用理由
- [ ] `渠道和库存 readiness` 已有事实、判断、未知项或不适用理由
- [ ] `内容、评价和广告冷启动` 已有事实、判断、未知项或不适用理由
- [ ] `里程碑、依赖和 owner` 已有事实、判断、未知项或不适用理由
- [ ] `领先指标、止损和复盘` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `GTM 计划` 已完整交付，并能由下游直接使用或审批
- [ ] `阶段门和责任矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `预算、指标与复盘设计` 已完整交付，并能由下游直接使用或审批
