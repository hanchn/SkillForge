...
- [ ] `需求与搜索信号` 已有事实、判断、未知项或不适用理由
- [ ] `竞争格局和价格带` 已有事实、判断、未知项或不适用理由
- [ ] `消费者场景与障碍` 已有事实、判断、未知项或不适用理由
- [ ] `法规、季节和渠道差异` 已有事实、判断、未知项或不适用理由
- [ ] `证据新鲜度与反证` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `市场情报简报` 已完整交付，并能由下游直接使用或审批
- [ ] `机会评分和证据表` 已完整交付，并能由下游直接使用或审批
- [ ] `验证计划与预警项` 已完整交付，并能由下游直接使用或审批
