...
- 核心判断：围绕客户场景、预算和硬约束、商品、价格、库存、履约与政策事实、语言、文化、隐私和品牌语气、意向、异议、线索分级和销售交接、知识版本、抽样质检、培训和 VOC 闭环逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付售前答复与商品推荐方案、客服 SOP、FAQ、话术和权限矩阵、线索、质检、培训与 VOC 改进报告，并给出验收证据、owner、截止和剩余风险。

## 场景 2：商品推荐、异议处理与多语言沟通
