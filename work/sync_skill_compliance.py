...
PROFILES = {
    ...
    "基础工具": {
        ...
        "title": "基础工具合规基线",
        "rules": [
            "消息、周报和复盘只能使用任务必要且已授权的数据；跨群、跨租户、对外发布、@全员和敏感信息触达必须单独审批。",
            "Webhook、token、应用密钥、cookie 和收件人标识不得写入 Skill、仓库、日志、截图或消息正文，必须通过密钥管理或已授权连接器引用。",
            "平台请求成功不等于送达、已读、认领或问题关闭；状态、回执、升级、关闭和效果必须分别验证。",
            "通用周报和复盘不得披露非必要个人信息、替代角色专属口径、制造归因或在证据不足时追责个人。",
        ],
    },
    "project-root": {
