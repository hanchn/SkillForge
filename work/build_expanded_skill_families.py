...
SPECS = [
    ...
    spec("创意拍摄/创意策略/creative-strategy-producer", "creative-strategy-producer", "跨境广告创意策略师", "creative-production", "从人群洞察和产品证据建立可拍摄、可批量测试、可归因的创意生产系统。", ["广告素材策略", "UGC brief 和脚本矩阵", "创意疲劳治理"], ["创意策略地图", "角度、钩子和脚本矩阵", "测试编码与复盘规则"], ["人群问题和欲望", "产品证据与演示", "角度、钩子、格式和 CTA", "平台原生表达", "变量隔离、标签和疲劳"], "不得虚构效果、评价或前后对比；策略必须能够转化为明确镜头和制作要求。"),
...
SPECS.extend([
    spec("互联网研发/产品/AI产品/ai-visual-tagging-product-architect", "ai-visual-tagging-product-architect", "AI 视觉打标产品架构师", "ai-product", "设计从图片输入、模型推理、标签建议、人审反馈到持续评估的可治理 AI 打标产品。", ["图片自动生成标签", "AI 打标工具产品规划", "模型打标质量、人工审核和反馈闭环"], ["AI 打标能力与用户流程", "标签体系、模型和人审决策", "评估、监控和演进路线"], ["图片来源、权限和数据边界", "标签 taxonomy、定义和版本", "模型、置信度和候选策略", "人工确认、拒绝和批量处理", "离线评估、线上监控和反馈学习"], "不得把模型输出直接当作事实；高风险或低置信度标签必须进入可配置的人审和追溯流程。"),
    ...
    spec("创意拍摄/素材运营/creative-asset-operations-manager", "creative-asset-operations-manager", "创意素材运营经理", "creative-production", "建立跨商品、市场、渠道和投放场景的素材需求、生产、标签、版本、授权、分发和效果回流体系。", ["素材中台和资产库治理", "多渠道素材供给与复用", "素材版本、授权和效果复盘"], ["素材分类与需求地图", "生产排期、命名、版本和权限规范", "分发、效果标签和淘汰复用机制"], ["商品事实、市场和使用场景", "格式、尺寸、语言和渠道规格", "素材 ID、标签、版本和血缘", "肖像、音乐、字体和地域授权", "投放表现、疲劳、复用和归档"], "不得让无来源、过期授权或无法追溯产品版本的素材上线；素材效果必须按可比渠道、受众和投放条件解释。"),
    spec("创意拍摄/拍摄制作/product-photo-video-production-manager", "product-photo-video-production-manager", "商品图片与视频拍摄制作经理", "creative-production", "把营销目标、商品事实和渠道规范转化为可执行的图片与视频拍摄、后期、验收和交付计划。", ["商品主图、场景图和视频拍摄", "广告、社媒、达人和独立站素材制作", "跨市场拍摄重制与批量交付"], ["拍摄策略、shot list 和脚本", "人员、场地、样品、预算与排期", "后期、合规、质检和交付清单"], ["受众、卖点和证据镜头", "主图、细节、场景、UGC 和短视频格式", "样品、模特、场地、灯光和收音", "分镜、镜头、字幕、音乐和 CTA", "色差、真实性、授权、命名和多规格交付"], "不得通过后期改变产品关键事实、尺寸、颜色或效果；模特、场地、音乐、字体和用户内容必须有明确授权范围。"),
    spec("创意拍摄/拍摄统筹/shooting-production-coordinator", "shooting-production-coordinator", "拍摄制片与现场统筹", "creative-production", "把创意方案转化为预算、排期、样品、人员、场地、设备、通告和现场执行计划。", ["棚拍或外景拍摄筹备", "多 SKU 批量拍摄", "跨团队拍摄进度和成本治理"], ["制作预算与排期", "人员、样品、场地和设备清单", "通告单、现场流程和异常预案"], ["brief、shot list 和优先级", "样品状态、道具和物流", "摄影、导演、模特和供应商", "场地、设备、保险和安全", "call sheet、备份、成本和交付节点"], "不得在缺少场地、肖像、未成年人、安全或商业使用授权时开拍；现场变更必须记录对预算、范围和交付的影响。"),
    spec("创意拍摄/商品摄影/product-photography-director", "product-photography-director", "商品摄影导演", "creative-production", "以真实还原商品和渠道转化任务为目标，设计主图、细节、场景、模特和对比图片的摄影方案。", ["Amazon 或独立站商品摄影", "新品主图与场景图拍摄", "多颜色多款式批量摄影"], ["商品摄影 brief 与 shot list", "灯光、构图、色彩和场景方案", "选片、真实性和渠道验收清单"], ["商品结构、材质、颜色和比例", "白底、细节、尺度和使用场景", "灯光、镜头、构图和景深", "模特姿态、道具和文化语境", "色彩管理、修图边界和渠道规范"], "不得通过透视、合成或修图夸大尺寸、材质、功能和效果；关键颜色与结构必须建立实物对照和可复核标准。"),
    spec("创意拍摄/短视频制作/short-form-video-producer", "short-form-video-producer", "跨境短视频制作导演", "creative-production", "面向广告、TikTok、Reels、Shorts 和商品页设计高密度、平台原生、可测试的短视频。", ["商品广告短视频", "社媒竖屏内容", "功能演示、场景故事和口播制作"], ["视频角度与脚本矩阵", "分镜、镜头、字幕和声音方案", "版本测试、平台规格和验收清单"], ["首秒钩子和目标人群", "问题、证据、演示和 CTA", "9:16 构图、节奏和安全区", "口播、字幕、音乐和无声观看", "变量编码、版本差异和完播转化指标"], "不得伪造演示、评价或前后对比；音乐、字体、素材和人物必须具备对应平台、地域、期限和商业用途授权。"),
...
ROLE_DEFS = [
    ...
    ("创意拍摄/创意角色", "创意拍摄高级经理", "senior-creative-production-manager", "创意拍摄高级经理", "统筹创意策略、制片、摄影、短视频、UGC、后期、素材资产、预算和生产质量。", ["创意需求和产能组合", "策略、脚本和拍摄优先级", "人员、供应商、预算和排期", "真实性、授权、品牌和质量", "素材交付、复用和效果回流"]),
...
BUSINESS_ROLE_NAMES = {
    ...
    "senior-creative-production-manager": "创意拍摄资深经理",
...
SPECS.extend([
    ...
    spec("人事招聘/岗位与JD/job-description-generator", "job-description-generator", "岗位说明书与招聘 JD 生成专家", "hr", "把真实业务目标、岗位成功标准和组织边界转化为清晰、可评估、包容且适合发布的岗位说明书与招聘 JD。", ["新增或重写招聘 JD", "岗位职责模糊或要求堆砌", "多平台、多语言或跨区域岗位发布"], ["内部岗位说明书", "候选人版招聘 JD", "能力证据、面试评估和发布检查表"], ["岗位使命、业务结果和上下游", "职责、权限与不负责范围", "必需能力、可培养能力和证据", "工作地、用工方式、汇报和协作", "薪酬披露、包容性、隐私和当地合规"], "不得虚构薪资、福利、组织承诺或岗位事实；不得加入与工作无关或可能造成歧视的年龄、性别、婚育、户籍、健康等条件。"),
...
CATEGORIES = {
    ...
    "创意拍摄/短视频制作": ("短视频制作", "管理广告、社媒和商品短视频的脚本、分镜、拍摄、声音和版本测试。"),
    "创意拍摄/UGC制作": ("UGC 与达人内容制作", "管理创作者、寄样、brief、拍摄反馈、授权和交付。"),
    "创意拍摄/拍摄制作": ("图片与视频拍摄制作", "统筹商品图片视频的整体拍摄、后期、验收和交付项目。"),
    "创意拍摄/后期交付": ("后期交付", "管理选片、剪辑、修图、调色、声音、字幕、本地化和多规格交付。"),
...
CATEGORIES.update({
    "互联网研发/产品/AI产品": ("AI 产品", "覆盖模型能力、人工协同、质量评估、成本、监控和反馈学习的 AI 产品设计。"),
