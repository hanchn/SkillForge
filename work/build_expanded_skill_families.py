...
SPECS = [
    ...
    spec("项目管理/公共/commerce-systems-product-architecture", "commerce-systems-product-architecture", "跨境业务系统总产品架构师", "product-system", "设计 OMS、IMS、OFS、CMS、WMS、TMS、CRM、PLM 等系统的职责地图、主数据归属和端到端协同。", ["跨境业务系统蓝图", "系统边界重构", "新系统立项和集成治理"], ["业务能力与系统地图", "主数据和状态 ownership 矩阵", "跨系统流程、契约与演进路线"], ["业务能力和端到端旅程", "系统职责与不负责范围", "主数据和 source of truth", "命令、事件、状态和异常", "集成、SLA、审计和分阶段建设"], "不得先按现有部门或系统名称切边界，必须先锁定业务能力与贵司缩写口径。"),
