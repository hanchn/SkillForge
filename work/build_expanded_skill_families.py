...
CATEGORIES = {
    ...
    "互联网研发/产品/系统产品架构/OMS": ("OMS 项目", "订单管理系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/IMS": ("IMS 项目", "库存管理系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/OFS": ("OFS 项目", "订单履约系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/CMS": ("CMS 项目", "商品/内容管理系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/TMS": ("TMS 项目", "运输管理系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/CRM": ("CRM 项目", "客户关系系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/PLM": ("PLM 项目", "产品生命周期系统的产品架构和后续细分 Skill。"),
    "互联网研发/产品/系统产品架构/WMS": ("WMS 项目", "仓储管理系统的产品架构和后续细分 Skill。"),
}
