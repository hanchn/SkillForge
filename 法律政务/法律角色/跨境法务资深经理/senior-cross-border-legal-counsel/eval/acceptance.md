...
- [ ] `司法辖区和主体` 已有事实、判断、未知项或不适用理由
- [ ] `权利义务与授权` 已有事实、判断、未知项或不适用理由
- [ ] `监管、消费者和平台风险` 已有事实、判断、未知项或不适用理由
- [ ] `证据、时效和争议` 已有事实、判断、未知项或不适用理由
- [ ] `外部律师升级与整改闭环` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `法律风险组合与优先级` 已完整交付，并能由下游直接使用或审批
- [ ] `专项法律 Skill 编排` 已完整交付，并能由下游直接使用或审批
- [ ] `决策、升级律师和治理计划` 已完整交付，并能由下游直接使用或审批
