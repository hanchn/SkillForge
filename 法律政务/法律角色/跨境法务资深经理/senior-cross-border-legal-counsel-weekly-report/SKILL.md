---
name: senior-cross-border-legal-counsel-weekly-report
description: 基于真实案件、合同和监管证据生成法务周报。 Use when an AI needs to handle 法务周度复盘, 重大风险与案件升级, 合同、合规和整改跟踪; produce 法务周报, 风险与时效台账, 决策、外部律师和下周行动; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
