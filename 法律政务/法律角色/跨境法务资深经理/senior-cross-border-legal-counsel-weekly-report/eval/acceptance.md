...
- [ ] `新增与关闭事项` 已有事实、判断、未知项或不适用理由
- [ ] `风险等级和金额暴露` 已有事实、判断、未知项或不适用理由
- [ ] `期限、证据和保全` 已有事实、判断、未知项或不适用理由
- [ ] `业务影响与整改` 已有事实、判断、未知项或不适用理由
- [ ] `待决策和外部律师事项` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `法务周报` 已完整交付，并能由下游直接使用或审批
- [ ] `风险与时效台账` 已完整交付，并能由下游直接使用或审批
- [ ] `决策、外部律师和下周行动` 已完整交付，并能由下游直接使用或审批
