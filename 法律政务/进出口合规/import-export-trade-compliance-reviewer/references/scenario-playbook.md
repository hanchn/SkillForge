...
- 核心判断：围绕出口方、进口商和最终受益人、商品描述、HS、原产地和估价、目的地、最终用户和最终用途、许可证、禁限运与主管机关、报关、运输、付款、筛查和记录保存逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付进出口合规审查报告、商品、主体、路线和责任矩阵、证据缺口、暂停条件和专业升级清单，并给出验收证据、owner、截止和剩余风险。
