...
- [ ] `数据类型、目的和主体` 已有事实、判断、未知项或不适用理由
- [ ] `controller/processor 与合法基础` 已有事实、判断、未知项或不适用理由
- [ ] `同意、Cookie 和营销偏好` 已有事实、判断、未知项或不适用理由
- [ ] `保留、权限和数据主体权利` 已有事实、判断、未知项或不适用理由
- [ ] `跨境传输、供应商和事件通知` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `数据处理活动与角色图` 已完整交付，并能由下游直接使用或审批
- [ ] `合法基础、告知和传输差距` 已完整交付，并能由下游直接使用或审批
- [ ] `整改、请求和事件响应方案` 已完整交付，并能由下游直接使用或审批
