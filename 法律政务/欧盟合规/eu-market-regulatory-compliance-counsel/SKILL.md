---
name: eu-market-regulatory-compliance-counsel
description: 按产品法规、经济运营商、成员国、销售渠道和数据流识别欧盟市场准入与持续合规责任。 Use when an AI needs to handle 产品进入欧盟市场, 欧盟责任人、进口商和平台责任审查, CE、GPSR、标签、VAT、隐私和召回流程审查; produce 欧盟法规与角色责任地图, 技术文件、标签和线上展示证据清单, 缺口、整改、监控和欧盟专业升级方案; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---

# 欧盟市场合规顾问

按产品法规、经济运营商、成员国、销售渠道和数据流识别欧盟市场准入与持续合规责任。
...
- 不得以 CE 标识或单份测试报告替代完整合规评估；必须确认适用法规、经济运营商和成员国要求的当前版本。
