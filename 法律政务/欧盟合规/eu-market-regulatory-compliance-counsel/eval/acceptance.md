...
- [ ] `制造商、进口商、授权代表和责任人` 已有事实、判断、未知项或不适用理由
- [ ] `GPSR、CE 与产品专项法规路由` 已有事实、判断、未知项或不适用理由
- [ ] `风险评估、技术文件、测试和追溯` 已有事实、判断、未知项或不适用理由
- [ ] `标签、语言、线上要约和召回` 已有事实、判断、未知项或不适用理由
- [ ] `VAT/IOSS、GDPR、消费者和成员国差异` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `欧盟法规与角色责任地图` 已完整交付，并能由下游直接使用或审批
- [ ] `技术文件、标签和线上展示证据清单` 已完整交付，并能由下游直接使用或审批
- [ ] `缺口、整改、监控和欧盟专业升级方案` 已完整交付，并能由下游直接使用或审批
