...
- [ ] `当事人、合同和管辖` 已有事实、判断、未知项或不适用理由
- [ ] `事实、损失和因果` 已有事实、判断、未知项或不适用理由
- [ ] `证据真实性和保全` 已有事实、判断、未知项或不适用理由
- [ ] `期限、程序和送达` 已有事实、判断、未知项或不适用理由
- [ ] `和解、执行和沟通权限` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `案件事实与时间线` 已完整交付，并能由下游直接使用或审批
- [ ] `请求、抗辩和证据地图` 已完整交付，并能由下游直接使用或审批
- [ ] `策略、成本、时效和升级计划` 已完整交付，并能由下游直接使用或审批
