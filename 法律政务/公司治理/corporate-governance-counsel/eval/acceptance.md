...
- [ ] `实体、股权和最终受益人` 已有事实、判断、未知项或不适用理由
- [ ] `章程与保留事项` 已有事实、判断、未知项或不适用理由
- [ ] `签字权和授权期限` 已有事实、判断、未知项或不适用理由
- [ ] `董事义务与利益冲突` 已有事实、判断、未知项或不适用理由
- [ ] `决议、申报和法定记录` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `实体和治理台账` 已完整交付，并能由下游直接使用或审批
- [ ] `授权与审批矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `决议、缺口和整改计划` 已完整交付，并能由下游直接使用或审批
