...
- [ ] `工作地与雇佣主体` 已有事实、判断、未知项或不适用理由
- [ ] `员工/承包商分类` 已有事实、判断、未知项或不适用理由
- [ ] `薪酬、工时、福利和税` 已有事实、判断、未知项或不适用理由
- [ ] `保密、IP、监控和隐私` 已有事实、判断、未知项或不适用理由
- [ ] `调查、纪律、终止和记录` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `用工分类与义务矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `合同和流程风险` 已完整交付，并能由下游直接使用或审批
- [ ] `整改、证据和律师升级清单` 已完整交付，并能由下游直接使用或审批
