...
- 核心判断：围绕Importer of Record 与海关申报、HTS、原产地、估价和供应链、CPSC/FDA/FCC 等产品主管机构路由、FTC 广告、评价和消费者保护、州级隐私、标签和执法差异逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付美国适用规则与主管机构地图、进口、产品和销售责任矩阵、证据缺口、整改和美国律师升级方案，并给出验收证据、owner、截止和剩余风险。
