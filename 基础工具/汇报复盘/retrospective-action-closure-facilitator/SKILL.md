---
name: retrospective-action-closure-facilitator
description: 基于事件、项目、活动或经营周期证据组织无责复盘，区分时间线、事实、促成条件和根因，并追踪行动到效果验证。 Use when an AI needs to handle 事故与异常复盘, 项目、发布或活动复盘, 月度季度经营复盘与重复问题治理; produce 证据化复盘报告, 促成因素、根因和系统性改进, 行动、owner、验证、关闭与复发监控台账; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
