---
name: general-company-weekly-report
description: 把一个团队或跨部门周期内的真实数据、交付、风险、决策和下周承诺整理成可核验周报，同时保留业务角色专属口径。 Use when an AI needs to handle 缺少专属角色 Skill 的团队周报, 跨部门项目周报, 管理层通用进展与风险汇报; produce 结论先行周报, 数据证据与状态对照表, 风险、决策、依赖和下周验收计划; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
