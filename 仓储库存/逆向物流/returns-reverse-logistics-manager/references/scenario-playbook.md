...
- 核心判断：围绕RMA、订单、原因和责任、运输、收货、身份和完整性、检验、分级、清洁和翻新、退款、可售、残次、报废和销毁、欺诈、产品安全、数据清除和根因闭环逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付逆向流程与状态机、检验分级和处置标准、退款、库存、追偿和根因报告，并给出验收证据、owner、截止和剩余风险。
