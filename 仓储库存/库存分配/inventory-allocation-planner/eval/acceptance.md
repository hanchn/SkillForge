...
- [ ] `现货、在途、预占和不可售` 已有事实、判断、未知项或不适用理由
- [ ] `渠道需求、承诺和优先级` 已有事实、判断、未知项或不适用理由
- [ ] `仓网、时效、成本和容量` 已有事实、判断、未知项或不适用理由
- [ ] `安全库存、配额和公平性` 已有事实、判断、未知项或不适用理由
- [ ] `调拨、同步、超卖和回收规则` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `库存分配规则与配额` 已完整交付，并能由下游直接使用或审批
- [ ] `仓渠道调拨计划` 已完整交付，并能由下游直接使用或审批
- [ ] `服务、成本、缺货和风险情景` 已完整交付，并能由下游直接使用或审批
