...
- [ ] `订单优先级、截单和释放` 已有事实、判断、未知项或不适用理由
- [ ] `波次、路径、拣选和缺货` 已有事实、判断、未知项或不适用理由
- [ ] `复核、包装、赠品和称重` 已有事实、判断、未知项或不适用理由
- [ ] `面单、装车、交接和出库状态` 已有事实、判断、未知项或不适用理由
- [ ] `错漏发、取消拦截、证据和追责` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `出库流程与波次方案` 已完整交付，并能由下游直接使用或审批
- [ ] `拣配复核包装标准` 已完整交付，并能由下游直接使用或审批
- [ ] `产能、SLA、异常和交接报告` 已完整交付，并能由下游直接使用或审批
