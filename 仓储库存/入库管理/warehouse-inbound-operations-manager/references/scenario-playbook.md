...
- 核心判断：围绕ASN、采购单、调拨单和到货、箱、托、SKU、批次和序列、计数、质检、短溢损和拒收、暂存、上架、库位和状态生效、IMS/WMS/采购/财务对账和证据逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付入库 SOP 与状态图、预约、收货、差异和上架任务表、SLA、证据、异常和对账清单，并给出验收证据、owner、截止和剩余风险。
