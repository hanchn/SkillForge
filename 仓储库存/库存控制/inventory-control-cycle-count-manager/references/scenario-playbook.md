...
- 核心判断：围绕库存所有权、位置、状态和批次、ABC/风险盘点频率、冻结、盲盘、复盘和抽查、收发、移库、退货和系统时序根因、调整权限、证据、损耗和审计轨迹逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付盘点策略与计划、账实差异和根因报告、调整审批、控制和持续改善清单，并给出验收证据、owner、截止和剩余风险。
