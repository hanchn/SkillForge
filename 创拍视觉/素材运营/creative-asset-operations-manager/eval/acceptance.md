...
- [ ] `商品事实、市场和使用场景` 已有事实、判断、未知项或不适用理由
- [ ] `格式、尺寸、语言和渠道规格` 已有事实、判断、未知项或不适用理由
- [ ] `素材 ID、标签、版本和血缘` 已有事实、判断、未知项或不适用理由
- [ ] `肖像、音乐、字体和地域授权` 已有事实、判断、未知项或不适用理由
- [ ] `投放表现、疲劳、复用和归档` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `素材分类与需求地图` 已完整交付，并能由下游直接使用或审批
- [ ] `生产排期、命名、版本和权限规范` 已完整交付，并能由下游直接使用或审批
- [ ] `分发、效果标签和淘汰复用机制` 已完整交付，并能由下游直接使用或审批
