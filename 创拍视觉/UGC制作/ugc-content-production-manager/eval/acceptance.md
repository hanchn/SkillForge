...
- [ ] `受众与创作者匹配` 已有事实、判断、未知项或不适用理由
- [ ] `真实体验和产品证据` 已有事实、判断、未知项或不适用理由
- [ ] `自然表达、钩子和镜头要求` 已有事实、判断、未知项或不适用理由
- [ ] `寄样、时间、费用和修改轮次` 已有事实、判断、未知项或不适用理由
- [ ] `广告披露、肖像内容授权和白名单投放` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `创作者画像与筛选表` 已完整交付，并能由下游直接使用或审批
- [ ] `UGC brief、脚本边界和反馈流程` 已完整交付，并能由下游直接使用或审批
- [ ] `授权、交付、版本和表现复盘` 已完整交付，并能由下游直接使用或审批
