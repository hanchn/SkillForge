...
- 核心判断：围绕首秒钩子和目标人群、问题、证据、演示和 CTA、9:16 构图、节奏和安全区、口播、字幕、音乐和无声观看、变量编码、版本差异和完播转化指标逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付视频角度与脚本矩阵、分镜、镜头、字幕和声音方案、版本测试、平台规格和验收清单，并给出验收证据、owner、截止和剩余风险。
