...
description: 面向广告、TikTok、Reels、Shorts 和商品页设计高密度、平台原生、可测试的短视频。 Use when an AI needs to handle 商品广告短视频, 社媒竖屏内容, 功能演示、场景故事和口播制作; produce 视频角度与脚本矩阵, 分镜、镜头、字幕和声音方案, 版本测试、平台规格和验收清单; and apply evidence, explicit boundaries, validation, and rollback instead of generic advice.
---
