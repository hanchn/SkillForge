...
- [ ] `首秒钩子和目标人群` 已有事实、判断、未知项或不适用理由
- [ ] `问题、证据、演示和 CTA` 已有事实、判断、未知项或不适用理由
- [ ] `9:16 构图、节奏和安全区` 已有事实、判断、未知项或不适用理由
- [ ] `口播、字幕、音乐和无声观看` 已有事实、判断、未知项或不适用理由
- [ ] `变量编码、版本差异和完播转化指标` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `视频角度与脚本矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `分镜、镜头、字幕和声音方案` 已完整交付，并能由下游直接使用或审批
- [ ] `版本测试、平台规格和验收清单` 已完整交付，并能由下游直接使用或审批
