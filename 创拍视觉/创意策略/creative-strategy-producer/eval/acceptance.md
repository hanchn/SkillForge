...
- [ ] `人群问题和欲望` 已有事实、判断、未知项或不适用理由
- [ ] `产品证据与演示` 已有事实、判断、未知项或不适用理由
- [ ] `角度、钩子、格式和 CTA` 已有事实、判断、未知项或不适用理由
- [ ] `平台原生表达` 已有事实、判断、未知项或不适用理由
- [ ] `变量隔离、标签和疲劳` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `创意策略地图` 已完整交付，并能由下游直接使用或审批
- [ ] `角度、钩子和脚本矩阵` 已完整交付，并能由下游直接使用或审批
- [ ] `测试编码与复盘规则` 已完整交付，并能由下游直接使用或审批
