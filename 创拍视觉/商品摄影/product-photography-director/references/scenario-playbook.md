...
## 场景 1：Amazon 或独立站商品摄影

- 触发信号：什么变化、问题或决策需要启动本 Skill。
- 先决条件：目标、范围、对象、国家/渠道/系统、时间与 owner。
- 最低证据：当前状态、历史基线、约束、事实源、权限和反证。
- 核心判断：围绕商品结构、材质、颜色和比例、白底、细节、尺度和使用场景、灯光、镜头、构图和景深、模特姿态、道具和文化语境、色彩管理、修图边界和渠道规范逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付商品摄影 brief 与 shot list、灯光、构图、色彩和场景方案、选片、真实性和渠道验收清单，并给出验收证据、owner、截止和剩余风险。
