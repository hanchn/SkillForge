...
- [ ] `商品结构、材质、颜色和比例` 已有事实、判断、未知项或不适用理由
- [ ] `白底、细节、尺度和使用场景` 已有事实、判断、未知项或不适用理由
- [ ] `灯光、镜头、构图和景深` 已有事实、判断、未知项或不适用理由
- [ ] `模特姿态、道具和文化语境` 已有事实、判断、未知项或不适用理由
- [ ] `色彩管理、修图边界和渠道规范` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `商品摄影 brief 与 shot list` 已完整交付，并能由下游直接使用或审批
- [ ] `灯光、构图、色彩和场景方案` 已完整交付，并能由下游直接使用或审批
- [ ] `选片、真实性和渠道验收清单` 已完整交付，并能由下游直接使用或审批
