...
- [ ] `brief、shot list 和优先级` 已有事实、判断、未知项或不适用理由
- [ ] `样品状态、道具和物流` 已有事实、判断、未知项或不适用理由
- [ ] `摄影、导演、模特和供应商` 已有事实、判断、未知项或不适用理由
- [ ] `场地、设备、保险和安全` 已有事实、判断、未知项或不适用理由
- [ ] `call sheet、备份、成本和交付节点` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `制作预算与排期` 已完整交付，并能由下游直接使用或审批
- [ ] `人员、样品、场地和设备清单` 已完整交付，并能由下游直接使用或审批
- [ ] `通告单、现场流程和异常预案` 已完整交付，并能由下游直接使用或审批
