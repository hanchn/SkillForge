...
- 核心判断：围绕brief、shot list 和优先级、样品状态、道具和物流、摄影、导演、模特和供应商、场地、设备、保险和安全、call sheet、备份、成本和交付节点逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付制作预算与排期、人员、样品、场地和设备清单、通告单、现场流程和异常预案，并给出验收证据、owner、截止和剩余风险。
