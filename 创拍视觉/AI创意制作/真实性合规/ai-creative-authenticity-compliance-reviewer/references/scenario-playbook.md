...
- 核心判断：围绕商品事实与生成差异、人像、声音、肖像和深度合成、版权、商标、字体和训练来源、广告声明、误导和平台政策、内容凭证、模型版本、人工修改和审批证据逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付AI 创意逐项审查表、失真、权利和平台风险分级、修改、披露、留档和禁止上线清单，并给出验收证据、owner、截止和剩余风险。
