...
- 核心判断：围绕商品版型、纹理、颜色和遮挡、人物身份、年龄表达、体型和肤色覆盖、姿态、手部、接触点和物理合理性、输入人像、肖像权和训练使用授权、跨版本一致性、合成披露和失败样本逐项判断，不跳过不适用说明。
- 执行变体：标准、快速止损、数据不足、高风险审批和分阶段试点。
- 异常路径：缺数据、口径冲突、权限不足、依赖失败、部分成功、超时与回滚。
- 完成门槛：交付虚拟模特制作 brief、身份、姿态、商品一致性和版本方案、真实性、授权、偏差和交付验收报告，并给出验收证据、owner、截止和剩余风险。
