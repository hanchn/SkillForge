...
- [ ] `受众、卖点和证据镜头` 已有事实、判断、未知项或不适用理由
- [ ] `主图、细节、场景、UGC 和短视频格式` 已有事实、判断、未知项或不适用理由
- [ ] `样品、模特、场地、灯光和收音` 已有事实、判断、未知项或不适用理由
- [ ] `分镜、镜头、字幕、音乐和 CTA` 已有事实、判断、未知项或不适用理由
- [ ] `色差、真实性、授权、命名和多规格交付` 已有事实、判断、未知项或不适用理由

## 交付物

- [ ] `拍摄策略、shot list 和脚本` 已完整交付，并能由下游直接使用或审批
- [ ] `人员、场地、样品、预算与排期` 已完整交付，并能由下游直接使用或审批
- [ ] `后期、合规、质检和交付清单` 已完整交付，并能由下游直接使用或审批
